...
const AccordianComponent = (props: Props) => {
    ...
    const uniqueHeadings = [...new Set(data.map(item => item.Heading))];
    ...
    <Card className='w-9/12 mx-auto my-6'>
        ...
        <Accordion type="single" collapsible className="w-full px-10">
            ...
            <AccordionItem value={index.toString()}>
                ...
                <AccordionContent className='text-lg flex items-center justify-between space-x-4 border-b-[1.5px] border-blue-200 py-2 px-3'>
