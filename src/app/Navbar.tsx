          ...
          <div className='flex items-center space-x-5'>
            ...
            <DropdownMenu>
                <DropdownMenuTrigger asChild>
                    <DropdownMenuLabel className='text-base flex items-center font-medium hover:opacity-60 cursor-pointer'>Data <ChevronDown className="h-[1.2rem] w-[1.2rem]" /></DropdownMenuLabel>
                </DropdownMenuTrigger>
                <DropdownMenuContent>
                    <DropdownMenuItem>
                    ...
                    <DropdownMenuItem>
                        <Link href='/databased/uploaddata'>Upload Project Data</Link>
                    </DropdownMenuItem>
                    <DropdownMenuItem>
