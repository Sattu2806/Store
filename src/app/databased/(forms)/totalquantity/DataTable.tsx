...
export function DataTable<TData, TValue>({
  ...
  return (
    ...
    <div className="flex items-center py-4 ">
        ...
        />
        <Input
          placeholder="Filter by FoundationType"
          value={(table.getColumn("foundationType")?.getFilterValue() as string) ?? ""}
          onChange={(event) =>
            table.getColumn("foundationType")?.setFilterValue(event.target.value)
          }
          className="max-w-sm text-lg ml-3 mr-3"
        />
        <DropdownMenu>
