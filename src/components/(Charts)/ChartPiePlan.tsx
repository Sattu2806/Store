...
const ChartPiePlan = (props: Props) => {
  ...
  return (
    <div >
      <Card className=" relative py-3">
        ...
        <p className="absolute bottom-3 left-4 font-semibold"> Planned Available Resources (Direct / Indirect / Equipment) for {selectedMonth}</p>
